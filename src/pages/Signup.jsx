      ...
      <div className="auth-container animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-ink-muted">
            Start tracking your studies with <span className="font-medium text-forest">Ledger</span>
          </p>
        </div>
        ...
        {displayError && (
          <div className="auth-error animate-shake">
            ...
            <button onClick={() => { clearError(); setLocalError('') }} className="ml-auto text-redpen hover:text-ink transition-colors">
        ...
        {GOOGLE_CLIENT_ID && (
          <>
            <div className="auth-google-wrapper" id="google-signin-btn-signup" />
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-ink-muted">
            ...
            <Link to="/login" className="auth-link" onClick={() => { clearError(); setLocalError('') }}>
              Sign in
            </Link>
          </p>
        </div>
